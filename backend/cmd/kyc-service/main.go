...
import (
	...
	"github.com/atlas-platform/atlas/backend/internal/kyc/handler"
...
func main() {
	cfg := config.Load("kyc-service")
	cfg.Port = 8003
	cfg.Postgres.DBName = "kyc_db"
